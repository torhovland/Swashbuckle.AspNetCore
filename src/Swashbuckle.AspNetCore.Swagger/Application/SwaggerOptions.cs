...
namespace Swashbuckle.AspNetCore.Swagger
{
    public class SwaggerOptions
    {
        ...
        /// <summary>
        /// Sets a custom route for the OpenAPI JSON endpoint(s). Must include the {documentName} parameter
        /// </summary>
        public string OpenApiRouteTemplate { get; set; } = "openapi/{documentName}/openapi.json";
